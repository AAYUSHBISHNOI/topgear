    ...
    <div className="max-w-3xl mx-auto px-4 py-8 prose prose-indigo scroll-smooth">
      ...
      <section>
        ...
        <p>
          ...
          marketing campaigns. They tracked user behavior with Google Analytics
          to optimize their strategies continuously.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          leveraging data, companies can maximize their impact and drive growth.
        </p>
      </section>
      ...
      <section>
        ...
        <ul className=" space-y-0">
          ...
          <li>
            <a
              href="https://www.wordstream.com/digital-marketing"
              target="_blank"
              rel="noreferrer"
            >
              WordStream - Digital Marketing
            </a>
          </li>
          <li>
            <a
