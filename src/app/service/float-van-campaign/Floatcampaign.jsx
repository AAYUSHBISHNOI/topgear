...
const AccordionItem = ({ faq, index, openIndex, setOpenIndex }) => {
  ...
  return (
    <div className="bg-white border rounded-xl shadow-md overflow-hidden">
      ...
      >
        {faq.question}
        <span className={`text-xl ${isOpen ? "rotate-45" : "rotate-0"}`}>
          +
        </span>
      </button>
      <div
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
            {[
              ...
              <div
                key={index}
                className="flex items-start gap-6 bg-white p-6 rounded-xl shadow"
              >
            ...
            {[
              {
                name: "Ravi",
                quote:
                  "Great service and professional team. Highly recommended!",
              },
              {
                name: "Kuldeep",
                quote:
                  "Excellent results and timely execution. Very satisfied.",
              },
              {
                name: "Karan",
